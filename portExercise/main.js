		...
		switch (_p0.ctor) {
			...
			case 'Decrement':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{counter: model.counter - 1, decrements: model.decrements + 1}),
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {counter: a, decrements: b, increments: c};
	});
var _user$project$Main$initialModel = A3(_user$project$Main$Model, 0, 0, 0);
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'# of increments: ',
										_elm_lang$core$Basics$toString(model.increments))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'# of decrements: ',
											_elm_lang$core$Basics$toString(model.decrements))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Decrement":[],"NoOp":[],"Increment":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
